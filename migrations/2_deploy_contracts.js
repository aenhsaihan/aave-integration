...
const lpAddressesProviderAddress = "0x24a42fD28C976A61Df5D00D0599C34c4f90748c8";
...
module.exports = function (deployer) {
  deployer.deploy(CTokensOracle, lpAddressesProviderAddress).then(() =>
    deployer
      .deploy(
        PriceOracleProxy,
        lpAddressesProviderAddress,
        CTokensOracle.address
      )
      .then(() =>
        deployer
          .deploy(
          ...
          .then(() => {
            console.log(TokenSetsDecomposer.address);
          })
      )
  );
};
